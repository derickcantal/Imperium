...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT loginid,username,FirstName,LastName,EmailAddress,ContactNo,Privilege,Status, FROM login WHERE username = ?";
        
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssssss",$param_loginid, $param_username, $param_FirstName,$param_LastName,$param_EmailAddress,$param_ContactNo,$param_Privilege,$param_Status);
